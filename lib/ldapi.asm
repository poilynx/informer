section .text
	global _FindInKernel32
	global _Find_LoadLibraryA
	global _Find_GetProcAddress
_FindInKernel32:
	push ebp
	mov ebp,esp

	fs mov eax,[0x30]				;fs points to teb in user mode，get pointer to peb
...
_Find_GetProcAddress:
	push 0x41636f72    ;rocA
	push 0x50746547    ;Getp
	call _FindInKernel32
	ret
